...
const KhungHoanThanh = ({id,demso,giotime,sotime}) => {
             ...
             {lichChieu.map((item,index)=>
                        {
                            ...
                            return (
                            <div id={`huhu${index}`} className={`${index===0?"tab-pane fade show active":"tab-pane fade"}`} key={index}>
                                                                    ...
                                                                    if(allCategories.includes(sotime))
                                                                        {
                                                                            ...
                                                                            return (
                                                                                <div className=" ml-md-3  mt-2 mb-2 py-3 border-bottom maulen" key={indexss}>
